...
![Release](https://img.shields.io/badge/release-v0.1.1--test.7-blue?style=for-the-badge)
...
The following commands are already pinned to `v0.1.1-test.7`. Copy the command
...
- [Current release notes](releases/v0.1.1-test.7.md)
