...
![Release](https://img.shields.io/badge/release-v0.1.1--test.28-blue?style=for-the-badge)
...
| --- | --- | --- |
| `v0.1.1-test.28` | `2026-08-26` | `test` |
...
The following commands are already pinned to `v0.1.1-test.28`. Copy the command
...
- [Current release notes](releases/v0.1.1-test.28.md)
